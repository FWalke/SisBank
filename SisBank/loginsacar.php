...
<html>
<head>
<title>Login de conta para sacar</title>
</head>

<h1><font color="green">Login de conta para sacar</font></h1>
...
<form method="post" action="">
    ...
    <button style="background-color:green; color: white">
        <a href="menulancamento.php" style="background-color:green; color: white; text-decoration: none;">Voltar</a>
    </button>
</form>
...
if (isset($_POST['confirmar'])):
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if (password_verify($senha, $senha_crip)) {
            header("Location: valorsaque.php?conta=$conta&agencia=$agencia");
            exit();
        } else {
